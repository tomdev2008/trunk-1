...
//    }
    ...
    public int getTempAge() {
        int age = LocalStorage.getInstance().getInt(LocalStorageKey.KEY_STORAGE_TEMP_AGE, 22);
        return age;
    }

    public void saveTempAge(int age) {
        //持久化保存
        LocalStorage.getInstance().putInt(LocalStorageKey.KEY_STORAGE_TEMP_AGE, age);
    }
    public int getTempSex() {
        int sex = LocalStorage.getInstance().getInt(LocalStorageKey.KEY_STORAGE_TEMP_SEX, 1);
        return sex;
    }

    public void saveTempSex(int sex) {
        //持久化保存
        LocalStorage.getInstance().putInt(LocalStorageKey.KEY_STORAGE_TEMP_SEX, sex);
    }
}
