...
public class EmptyView extends FrameLayout implements View.OnClickListener {
    ...
    public void attatchWithView(View view, CallBack callBack) {
        mAttatchedView = view;
        mCallBack = callBack;
    }
    ...
    public void startLoading() {
        ...
        if (mAttatchedView != null && mCallBack.needHideContentView()) {
            mAttatchedView.setVisibility(INVISIBLE);
        }
    }
    ...
    public void loadingComplete() {
        if (mAttatchedView != null && mAttatchedView.getVisibility() != VISIBLE) {
            mAttatchedView.setVisibility(VISIBLE);
        }
