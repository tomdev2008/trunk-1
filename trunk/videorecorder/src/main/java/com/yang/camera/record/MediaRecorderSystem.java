	...
	protected void concatVideoParts() {
		new AsyncTask<Void, Void, Boolean>() {
			...
			protected Boolean doInBackground(Void... params) {
				...
				//合并ts流
				cmd = String.format("ffmpeg %s -i \"%s\" -vf \"%s\" %s -acodec copy -absf aac_adtstoasc -f mp4 -r 15 -movflags faststart \"%s\"", FFMpegUtils.getLogCommand(), mMediaObject.getConcatYUV(), vf, FFMpegUtils.getVCodecCommand(), mMediaObject.getOutputTempVideoPath());
