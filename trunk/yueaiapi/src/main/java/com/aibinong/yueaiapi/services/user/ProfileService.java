...
public interface ProfileService {
    @FormUrlEncoded
    @POST("/user/profile/user.html")
    @DataChecker
    @DataPaser
    Observable<JsonRetEntity<GetUserEntity>>
    get_user(
    ...
    @FormUrlEncoded
    @POST("/user/profile/feedback.html")
    @DataChecker
    @DataPaser
