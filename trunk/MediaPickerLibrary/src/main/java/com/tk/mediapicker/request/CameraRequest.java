...
import static com.tk.mediapicker.Constants.AlbumRequestConstants.CROP_RATIO_WH;
import static com.tk.mediapicker.Constants.AlbumRequestConstants.MAX_CROP_WIDTH;
...
//        }
    ...
    public static final class Builder {
        ...
        public Builder maxCropWidth(int size) {
            bundle.putInt(MAX_CROP_WIDTH, size);
            return this;
        }

        public Builder cropRatioWh(float ratio) {
            bundle.putFloat(CROP_RATIO_WH, ratio);
            return this;
        }
        /**
         * 拍照是否调用系统支持的拍照
