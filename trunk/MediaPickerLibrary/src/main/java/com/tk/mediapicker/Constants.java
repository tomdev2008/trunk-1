...
public final class Constants {
    ...
    public static final int DEFAULT_MAX_CROPED_SIZE = 800;
    public static final float DEFAULT_CROPED_RATIO_WH = 1.0f;
    ...
    public static final class AlbumRequestConstants {
        ...
        public static final String MAX_CROP_WIDTH="max_crop_width";
        public static final String CROP_RATIO_WH="crop_ratio_wh";
