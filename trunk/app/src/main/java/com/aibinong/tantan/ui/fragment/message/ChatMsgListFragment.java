...
//        if (!UserUtil.isHelper(mChatToUseEntity)) {  //看看是不是小助手
//            //引导页是否展示过
//            if (!LocalStorage.getInstance().getBoolean(
//                    LocalStorageKey.KEY_STORAGE_GIFT_GUIDE_SHOW, false)) {
//                HighLightGuideView.builder(getActivity()).
//                        addHighLightGuidView(mIbtnChatGift, R.mipmap.songli)
//                        .setHighLightStyle(HighLightGuideView.VIEWSTYLE_OVAL).
//                        show();
//                UserUtil.saveGiftGudieShow(true);
//            }
//
//        }
