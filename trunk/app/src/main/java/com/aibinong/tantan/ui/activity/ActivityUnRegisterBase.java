...
//        };
        mShowLoginReciever = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                //跳到选择登录页面
                Intent firstIntent = new Intent(ActivityUnRegisterBase.this, SplashActivity.class);
        ...
        askForLoginDialog.setOnClickListener(new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (which == Dialog.BUTTON_NEGATIVE) {
                    //取消
                    //前往登录界面
                    RegisterActivity.launchIntent(ActivityUnRegisterBase.this, true);
                }
            }
        });
    ...
    public void askForBuyVip() {
        ...
        askForLoginDialog.setOnClickListener(new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (which == Dialog.BUTTON_NEGATIVE) {
                    //vip认证
                    VipCertActivity.launchIntent(ActivityUnRegisterBase.this);
                } else {
                    //钻石
                    CommonWebActivity.launchIntent(ActivityUnRegisterBase.this, CommonUtils.getCommonPageUrl(Constant._sUrl_vip_buy, null));
                }
            }
        });
//        askForLoginDialog.setCancelable(false);
            ...
            if (BaseEvent.ACTION_SYS_MESSAGE.equals(baseEvent.action)) {
                ...
                if (((BaseEvent) event).data != null && ((BaseEvent) event).data instanceof PushMessage) {
                    ...
                    if (pushMessage.data != null) {
                        ...
                        Intent contentIntent = CommonPushMessageHandler.createIntent(this, pushMessage.messageType, pushMessage.data.targetId, pushMessage.data.url, pushMessage);
                        pendingIntent = PendingIntent.getActivity(ActivityUnRegisterBase.this, 0, contentIntent, PendingIntent.FLAG_ONE_SHOT);
                    }
