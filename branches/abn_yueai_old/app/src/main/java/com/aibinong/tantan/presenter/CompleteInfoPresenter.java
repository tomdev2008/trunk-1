...
public class CompleteInfoPresenter extends PresenterBase {
    ...
    public void register(ArrayList<String> portrait, String nickname, String birthdate, int sex, String occupation, ArrayList<String> tagsArr) {
        ...
        addToCycle(ApiHelper.getInstance()
                ...
                .register(pictureBuilder.toString(), nickname, birthdate, sex, occupation, tagsArrBuilder.toString())
