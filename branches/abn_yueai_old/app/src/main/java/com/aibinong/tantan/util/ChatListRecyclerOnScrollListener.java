 ...
 */
public class ChatListRecyclerOnScrollListener extends RecyclerView.OnScrollListener implements OnListLoadNextPageListener {
    ...
    public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
        ...
        if (layoutManager instanceof GridLayoutManager) {
            ...
            loadmoreAhead = gridLayoutManager.getSpanCount() * 2;
        }
        if ((visibleItemCount > 0 && currentScrollState == RecyclerView.SCROLL_STATE_IDLE && firstVisibleItemPosition <= loadmoreAhead)) {
