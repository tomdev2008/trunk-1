 ...
 * refreshing It defines {@link in.srain.cube.views.ptr.PtrUIHandler}, which
 * allows you customize the UI easily.
 */
public class PtrFrameLayout extends ViewGroup {
    ...
    private PtrUIHandlerHolder mPtrUIHandlerHolder = PtrUIHandlerHolder
            .create();
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mContent != null) {
            ...
            if (DEBUG && DEBUG_LAYOUT) {
                ...
                PtrCLog.d(LOG_TAG,
                        "onMeasure, mCurrentPos: %s, mLastPos: %s, top: %s",
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (DEBUG) {
                    ...
                    PtrCLog.v(
                            LOG_TAG,
                            "ACTION_MOVE: offsetY:%s, mCurrentPos: %s, moveUp: %s, canMoveUp: %s, moveDown: %s: canMoveDown: %s",
    ...
    private void updatePos(int change) {
        ...
        if ((mPtrIndicator.hasJustLeftStartPosition() && mStatus == PTR_STATUS_INIT)
                ...
                && mStatus == PTR_STATUS_COMPLETE && isEnabledNextPtrAtOnce())) {
    ...
    class ScrollChecker implements Runnable {
        ...
        private void finish() {
            if (DEBUG) {
                PtrCLog.v(LOG_TAG, "finish, mCurrentPos:%s",
                        mPtrIndicator.getCurrentPosY());
            }
            reset();
            onPtrScrollFinish();
